                        ...
                        <div class="header-right">
                            <div class="filter-box ml-15 d-none d-md-flex">
                                <button class="" type="button" id="filter">
                                    <img src="../assets/image/me.png" alt="" width="30px">
                                </button>
                            </div>
                            <!-- filter end -->
                            <!-- profile start -->
                        ...
                        <div class="table-wrapper table-responsive" style="max-height: 360px; overflow-y: scroll;">
                            ...
                            if ($result) {
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    echo "<th class='p-2'>Akte Kelahiran</th>";
                                    echo "<th class='p-2'>Surat Keterangan dari Agama</th>";
                                    echo "<th class='p-2'>Alamat/th>";
                                    echo "<th class='p-2'>Surat Keterangan Sehat</th>";
                                    echo "<th class='p-2'>KTP</th>";
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<td class='p-2'>" . $row['surat_pemberkatan_perkawinan'] . "</td>";
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <form action="load/layanannikah.php" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="input-style-2">
                                        <label>Alamat</label>
                                        <input type="text" id="surat_pemberkatan_perkawinan"
                            ...
                            <div class="col-lg-6">
                                ...
                                <form action="load/keterangan_pernah_nikah.php" method="POST" class="card-style mb-30">
                                    <h6 class="mb-25">Layanan Keterangan Pernah Nikah</h6>
                                    <div class="input-style-1">
                                        <label>Nama</label>
